...
public class Background extends Actor {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(textureRegion, textureRegionBounds1.x, textureRegionBounds1.y, Constants.APP_WIDTH+5,
                Constants.APP_HEIGHT);
        batch.draw(textureRegion, textureRegionBounds2.x, textureRegionBounds2.y, Constants.APP_WIDTH+5,
                Constants.APP_HEIGHT);
    }
